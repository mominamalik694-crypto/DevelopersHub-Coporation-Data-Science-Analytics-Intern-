...
# Data Science Internship Tasks Overview
**Author:** Momina Malik

Welcome to the repository of my Data Science Internship Tasks! This repository contains a series of 5 distinct machine learning and data analysis projects. Each task focuses on a different aspect of data science, ranging from exploratory data analysis and visualization to building predictive classification and regression models.
...
- **Highlights:** Extracted valuable business insights regarding target demographics and built a predictive model to help banks optimize their targeted marketing strategies.

---

*Feel free to explore the individual `README.md` files linked above for detailed step-by-step walkthroughs and code snippets for each task.*
